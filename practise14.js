 ...
 console.log(`The Length & Total Element Of Array is : ${array}`);
 const array1 = arrayNumbers[0];
 console.log(`The First element is : ${array1}`);
...
console.log(sum2);
  ...
  let result = arrayNum6.includes(155);
  console.log(`Is 115 Is Available For Array : ${result} `);

  console.log("=========== Is 23 Available From Array =======");
  let arrayNum7 = [20,31,40,25,23,11,29,9,60,2,11];
  let result1= arrayNum7.includes(23);
  console.log(`Is 23 No Available from array : ${result1}`);
